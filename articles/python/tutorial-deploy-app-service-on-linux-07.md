...
AI 및 Machine Learning Service와 함께 데이터 스토리지를 포함하여 Python에서 사용할 수 있는 Azure 서비스에 대해 자세히 알아보려면 [Azure Python 개발자 센터](/python/azure/?view=azure-python)를 참조하세요.
...
> [완료했습니다!](/python/azure/?view=azure-python) 
