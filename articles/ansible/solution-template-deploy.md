...
- **Azure CLI(명령줄 인터페이스) 2.0** - [Azure CLI 2.0](/cli/azure/)은 Azure 리소스를 관리하기 위한 플랫폼 간 명령줄 환경입니다. 
...
1. 포털 페이지 맨 위에서 **알림** 아이콘을 선택하여 Ansible 배포를 추적합니다. 배포가 완료되면 **리소스 그룹으로 이동** 을 선택합니다. 
     ...
     ![Ansible 배포에 대한 Azure Portal 알림](./media/solution-template-deploy/portal-ansible-setup-complete.png)
