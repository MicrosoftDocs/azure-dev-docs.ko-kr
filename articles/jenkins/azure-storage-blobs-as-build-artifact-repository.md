...
4. **Blob name**에서 Blob 이름을 지정합니다. 환경 변수를 사용할 수 있습니다. Blob 이름의 첫 부분 글자를 지정한 후에 와일드카드로 별표를 사용할 수도 있습니다. 예를 들어 **project\\** *는 **project**라는 이름으로 시작하는 모든 Blob을 지정합니다.
...
* **URL 형식**: 다음 URL 형식을 사용하여 Blob에 주소를 지정할 수 있습니다.
    ...
    위의 형식은 전역 Azure 클라우드에 적용됩니다. 다른 Azure 클라우드를 사용하는 경우 [Azure Portal](https://portal.azure.com) 내의 엔드포인트를 사용하여 URL 엔드포인트를 확인합니다.
