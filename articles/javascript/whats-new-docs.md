...
ms.locfileid: "99510964"
---
# <a name="javascript-docs-whats-new"></a>JavaScript 문서: 새로운 내용

JavaScript 및 TypeScript 개발자를 위한 새로운 콘텐츠 및 업데이트된 콘텐츠를 찾아보세요.

## <a name="2021-february"></a>2021년 2월

### <a name="whats-new"></a>새로운 기능

|이름|메모|
|---------------------------------------|--|
|[Azure Cosmos DB에서 MongoDB를 사용하는 방법](./how-to/with-database/use-mongodb-as-cosmosdb.md)|mongoDB 데이터베이스를 만들거나, 이동하거나, Azure로 사용하려면 Cosmos DB 리소스가 필요합니다. 리소스를 만들고 데이터베이스를 사용하는 방법을 알아봅니다. |
...
|속성|메모|
|---------------------------------------|--|
|[Developer Advocates의 새로운 기능](whats-new-developer-advocacy.md)|블로그, 비디오, 학습 모듈|
|[자습서: 텍스트 음성 변환](./tutorial/convert-text-to-speech-cognitive-services.md)|이 자습서에서는 Cognitive Services Speech Service를 통해 기존 Express.js 앱에 Cognitive Services 음성을 추가하여 텍스트를 음성으로 변환하는 기능을 추가합니다. 텍스트를 음성으로 변환하면 오디오를 수동으로 생성하는 데 비용을 들이지 않고 오디오를 제공할 수 있습니다.|
|Azure CLI 사용 방법 가이드|* [컨테이너 레지스트리 만들기 및 사용](./how-to/with-azure-cli/create-container-registry-resource.md)<br>* [사용자 지정 도메인 이름 구성](./how-to/with-azure-cli/configure-app-service-custom-domain-name.md)<br>* [Cosmos DB를 사용하여 Azure에서 MongoDB 만들기 및 사용](./how-to/with-azure-cli/create-mongodb-cosmosdb.md) |
|Visual Studio Code 사용 방법 가이드|* [Node.js 개발 및 디버그](./how-to/with-visual-studio-code/install-run-debug-nodejs.md)<br>* [GitHub 리포지토리 복제 및 사용](./how-to/with-visual-studio-code/clone-github-repository.md)<br>* [로컬 JavaScript 프로젝트에서 컨테이너 이미지 만들기](./how-to/with-visual-studio-code/containerize-local-project.md)|
...
|[Visual Studio Code 시작 파일 구성](./how-to/configure-web-app-settings.md#configure-browser-for-cors-to-connect-with-server)|자체 서버에 연결해야 하고 클라이언트에서 로컬로 실행하고 디버깅하는 동안 CORS 보안을 무시해야 하는 경우 권장되는 솔루션은 Visual Studio Code 디버그 파일(`launch.json`)에서 이 설정을 구성하여 보안을 사용하지 않는 설정을 브라우저에 전달하는 것입니다.|
